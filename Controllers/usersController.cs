...
namespace KozoskodoAPI.Controllers
{
    ...
    public class usersController : ControllerBase
    {
        ...
        private async Task<IActionResult> ValidateUserData(ModifyUserInfoDTO userInfoDTO, Personal user)
        {
            ...
            //    {
            //        Study newStudy = new Study(user.id, userInfoDTO.SchoolName, userInfoDTO.Class, userInfoDTO.StartYear, userInfoDTO.EndYear);
            //        await _userRepository.InsertAsync(newStudy);
            //    }
            //    else
            //    {
            //        var userStudy = await _userRepository.GetByIdAsync<Study>(user.id);
